// from https://unpkg.com/@flatten-js/core?module
...
class SVGAttributes {
  constructor(args = defaultAttributes) {var _args$stroke;
    for (const property in args) {
      this[property] = args[property];
    }
    this.stroke = (_args$stroke = args.stroke) !== null && _args$stroke !== void 0 ? _args$stroke : defaultAttributes.stroke;
  }
      ...
      while (edge_tmp != edge_to1) {
        if (edge_tmp.bvStart === edge_from1.bv && edge_tmp.bvEnd === edge_to1.bv) {
          ...
          if (dist < 10 * Flatten.DP_TOL) {// it should be very close
            ...
            if (int_point1.is_vertex & END_VERTEX) {// nothing to split
            ...
            if (int_point2.is_vertex & END_VERTEX) {// nothing to split
...
let Point$3 = class Point extends Shape {
  ...
  /**
     ...
     * @returns {String}
     */
  svg(attrs = {}) {var _attrs$r;
    const r = (_attrs$r = attrs.r) !== null && _attrs$r !== void 0 ? _attrs$r : 3; // default radius - 3
...
function parseMutliPolygon(multiPolygonString) {
  ...
  const polygon = new Polygon();
  const faces = polygons.reduce((acc, polygon) => [...acc, ...(polygon === null || polygon === void 0 ? void 0 : polygon.faces)], []);
  faces.forEach(face => polygon.addFace([...(face === null || face === void 0 ? void 0 : face.shapes)]));
  return polygon;
}
...
function parseWKT(str) {
  ...
  if (str.startsWith("POLYGON") || str.startsWith("MULTIPOLYGON")) {
  ...
  if (isArrayOfPoints(str)) {
    return parseArrayOfPoints(str);
  } else
  if (isArrayOfLines(str)) {
    return parseArrayOfLineStrings(str);
  }
  return [];
}

function isArrayOfPoints(str) {var _str$split;
  return (_str$split = str.split('\n')) === null || _str$split === void 0 ? void 0 : _str$split.every(str => str.includes('POINT'));
}

function isArrayOfLines(str) {var _str$split2;
  return (_str$split2 = str.split('\n')) === null || _str$split2 === void 0 ? void 0 : _str$split2.every(str => str.includes('LINESTRING'));
}
